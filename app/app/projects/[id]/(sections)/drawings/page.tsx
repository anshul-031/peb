  ...
  return (
    <div>
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        <a className="rounded bg-zinc-900 px-3 py-2 text-white" href={`/api/drawings/dxf?projectId=${project.id}&sheet=anchor`}>Anchor Bolt Plan (DXF)</a>
        <a className="rounded bg-indigo-600 px-3 py-2 text-white hover:bg-indigo-700" href={`/api/drawings/dxf?projectId=${project.id}&sheet=frame-elev`}>Frame Elevation (DXF)</a>
        <a className="rounded bg-emerald-600 px-3 py-2 text-white hover:bg-emerald-700" href={`/api/drawings/dxf?projectId=${project.id}&sheet=roof-plan`}>Roof Plan (DXF)</a>
  <a className="rounded bg-teal-700 px-3 py-2 text-white hover:bg-teal-800" href={`/api/drawings/dxf?projectId=${project.id}&sheet=footing-layout`}>Footing Layout (DXF)</a>
        <a className="rounded border px-3 py-2" href={`/api/reports/pdf?projectId=${project.id}`}>Frame Elevation (PDF)</a>
