  ...
  return (
    <div>
      ...
      <div className="mt-5 flex gap-3 flex-wrap">
        <a className="rounded bg-indigo-600 px-3 py-2 text-white hover:bg-indigo-700" href="/api/interop/ifc/export">Export IFC (stub)</a>
        <a className="rounded bg-fuchsia-600 px-3 py-2 text-white hover:bg-fuchsia-700" href="/api/interop/cis2/export">Export CIS/2 (stub)</a>
        <a className="rounded bg-emerald-600 px-3 py-2 text-white hover:bg-emerald-700" href="/api/drawings/dxf">Export DXF</a>
        <form action="/api/interop/ifc/import" method="post">
